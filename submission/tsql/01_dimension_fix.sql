...
-- Validated against: PostgreSQL (DuckDB) - logic identical;
--   two syntax deltas applied below.
...
-- T-SQL: ADD without COLUMN keyword
...
-- T-SQL: alias goes on the target table, not in the SET clause
UPDATE d
